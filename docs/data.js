...
<div class="sidenote"><i>Down the Rabbit-Hole</i></div>
...
<p>
  ...
  dear! I shall be too late!" (when<span class="pagenum"
    ><a name="Page_2" id="Page_2">[2]</a></span
  >
  ...
  Rabbit actually <i>took a watch out of its waistcoat-pocket</i>, and looked at
  it, and then hurried on, Alice started to her feet, for it flashed across her
...
<p>
  ...
  <i>very</i> good opportunity for showing off her knowledge, as there was no
  one to listen to her, still it was good practice to say it over) "—yes, that’s
  about the right distance—but then I wonder what Latitude or Longitude I’ve got
  to?" (Alice had no idea what Latitude was, or Longitude either, but thought
  they were nice grand words to say.)<span class="pagenum"
    ><a name="Page_5" id="Page_5">[5]</a></span
  >
</p>
...
<p>
  ...
  curtsey as she spoke—fancy <i>curtseying</i> as you’re falling through the
  air! Do you think you could manage it?) "And what an ignorant little girl
  she’ll think me! No, it’ll never do to ask: perhaps I shall see it written up
  somewhere."
</p>
...
<p>
  ...
  eat bats, I wonder?" And here Alice<span class="pagenum"
    ><a name="Page_6" id="Page_6">[6]</a></span
  >
  began to get rather sleepy, and went on saying to herself, in a dreamy sort of
  way, "Do cats eat bats? Do cats eat bats?" and sometimes, "Do bats eat cats?"
...
<p>
  ...
  up by a row of lamps hanging from the roof.<span class="pagenum"
    ><a name="Page_7" id="Page_7">[7]</a></span
  >
</p>
...
<p>
  ...
  any of them. However, on the second time round, she came upon a low curtain
...
<p>
  ...
  but<span class="pagenum"><a name="Page_8" id="Page_8">[8]</a></span> she could
  not even get her head through the doorway;
  <ins
    title="Transcriber’s Note: This opening quotation mark was added to the text"
    >Mollie</ins
  >
  ...
  many out-of-the-way things had happened lately, that Alice had begun to think
...
<p>
  ...
  whether it’s marked ’<i>poison</i>’ or not;" for she had read several nice
  little stories about children who had got burnt,<span class="pagenum"
    ><a name="Page_9" id="Page_9">[9]</a></span
  >
  and eaten up by wild beasts, and other unpleasant things, all because they
  <i>would</i> not remember the simple rules their friends had taught them: such
  as, that a red-hot poker will burn you if you hold it too long; and that, if
  you cut your finger <i>very</i> deeply with a knife, it usually bleeds; and
...
<p>
  However, this bottle was <i>not</i> marked "poison," so Alice ventured to
  taste it, and finding it very nice (it had, in fact, a sort of mixed flavour
  of cherry-tart, custard, pineapple, roast turkey, coffee, and hot buttered
...
<p>
  ...
  that little door into that lovely garden. First, however, she<span
    class="pagenum"
    ><a name="Page_10" id="Page_10">[10]</a></span
  >
  waited for a few minutes to see if she was going to shrink any further: she
  felt a little nervous about this: "for it might end, you know," said Alice to
  herself, "in my going out altogether, like a candle. I wonder what I should be
  like then?" And she tried to fancy what the flame of a candle looks like after
...
<p>
  ...
  very good advice (though she very seldom followed it), and sometimes she<span
    class="pagenum"
    ><a name="Page_11" id="Page_11">[11]</a></span
  >
...
<p>
  ...
  this is what generally happens<span class="pagenum"
    ><a name="Page_12" id="Page_12">[12]</a></span
  >
