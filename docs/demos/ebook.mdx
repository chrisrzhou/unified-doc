...
import DemoEbook from './src/demo-ebook';
...
## Implementation
This demo is extremely simple and uses the `window.confirm` method to implement bookmark actions.  These actions are implemented using the `onSelectText` and `onAnnotationClick` props.
