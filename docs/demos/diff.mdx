...
import DemoDiff from './src/demo-diff';

# Diff

## Description
A demo showing how to diff two files and using different ways to display the diffs.  This demo preloads HTML and markdown content for comparison.  This is a cool way to visualize how markdown differs *just slightly* from HTML, and why markdown is an *awesome* markup language that is interoperable with HTML!
